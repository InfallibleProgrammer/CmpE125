...
HD_PWD='C:/Users/avach/Documents/GitHub/CmpE125/Lab5/Pipelined Multiplier/Pipelined Multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parallel_mult_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parallel_mult_fpga.tcl
