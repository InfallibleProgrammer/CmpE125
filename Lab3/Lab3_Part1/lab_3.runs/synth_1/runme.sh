...
HD_PWD='C:/Users/avach/Documents/XilinixProjects/lab_3/lab_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_fpga.tcl
