...
HD_PWD='C:/Users/bcgni/Downloads/CmpE125Git/Lab7/FSM/FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FSM_fpga.tcl
