...
HD_PWD='C:/Users/bcgni/Downloads/CmpE125Git/Lab7/FSM/FSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSM_fpga.tcl -notrace
