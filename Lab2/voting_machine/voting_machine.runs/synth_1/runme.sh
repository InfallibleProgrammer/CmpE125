...
HD_PWD='C:/Users/avach/Documents/XilinixProjects/voting_machine/voting_machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log voting_rule_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source voting_rule_tb.tcl
